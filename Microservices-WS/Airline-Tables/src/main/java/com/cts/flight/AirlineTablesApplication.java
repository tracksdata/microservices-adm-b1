...
public class AirlineTablesApplication {
	...
	public static void main(String[] args) {
		...
		CoPassenger cp4 = new CoPassenger("Reet", "Kour", "Female");
		...
		BookingRecord b1=new BookingRecord(flight1.getFlightDate(), flight1.getFlightTime(), LocalDateTime.now(), flight1.getFlightNumber(), flight1.getOrigin(), flight1.getDestination(), flight1.getFare().getFare(), p1, flight1.getAirlineInfo(), "CONFIRMED");
		BookingRecord b2=new BookingRecord(flight2.getFlightDate(), flight2.getFlightTime(), LocalDateTime.now(), flight2.getFlightNumber(), flight2.getOrigin(), flight2.getDestination(), flight2.getFare().getFare(), p2, flight2.getAirlineInfo(), "CONFIRMED");
		BookingRecord b3=new BookingRecord(flight3.getFlightDate(), flight3.getFlightTime(), LocalDateTime.now(), flight3.getFlightNumber(), flight3.getOrigin(), flight3.getDestination(), flight3.getFare().getFare(), p3, flight3.getAirlineInfo(), "CONFIRMED");
