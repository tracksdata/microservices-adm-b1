...
public class CheckinServiceImpl implements CheckinService {
	...
	// communicates with booking service and gets booking details
	...
	*/
	...
	public CheckIn checkIn(int bookingId) {
		...
		BookingRecord bookingRecord = bookingServiceProxy.book(bookingId);
		// BookingRecord bookingRecord = restTemplate.getForObject(bookingURL + "/" +
		// bookingId, BookingRecord.class);
		...
		if (bookingRecord != null) { // booking existed
			...
			// get updated status of booking record and set it to checkin object
			// bookingRecord = restTemplate.getForObject(bookingURL + "/" + bookingId,
			// BookingRecord.class);
